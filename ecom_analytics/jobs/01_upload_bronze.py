...
"""
Bronze Layer: Upload raw CSV files từ local lên MinIO.
- Giữ nguyên dữ liệu gốc, không transform
- Lưu dưới dạng CSV trên MinIO
"""
import os
import io
import pandas as pd
...
# Đường dẫn local tới 3 file CSV RAW
...
def main():
    ...
    for name, filename in FILES.items():
        ...
        try:
            # Đọc CSV với error handling - dùng engine mặc định (c engine)
